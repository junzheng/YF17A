...
namespace YF17A
{
    public  class BeckHoff
    {
        ...
        public void writeAny(String plcVarName, Object value)
        {
            ...
            {
                Boolean flag = true;
                adsClient.WriteAny(mWriteFlagHandle, flag);
        ...
        private void initThreadHold()
        {
            ...
            plcVarThreadHoldMap.Add(".Corner_work_off_delay", new ThresHold() { max = 1000, min = 5, ratio = 100 }); //Int	最小烟层高度滞后		读/写	数值显示	DB8.DBW38	Corner_work_off_delay	%	10.0 	0.5 
            ...
            plcVarThreadHoldMap.Add(".Corner_entrance_hight_limit", new ThresHold() { max = 27850, min = 2785, ratio = 2.785F });  //Int	弯道入口传感器上限		读/写	数值显示	DB8.DBW74	Corner_entrance_hight_limit	mv	10000 	1000 
            plcVarThreadHoldMap.Add(".Corner_entrance_low_limt", new ThresHold() { max = 13925, min = 0, ratio = 2.785F }); //Int	弯道入口传感器下限		读/写	数值显示	DB8.DBW76	Corner_entrance_low_limt	mv	5000 	0 
            ...
            plcVarThreadHoldMap.Add(".Downport_Highest_limit", new ThresHold() { max = 27850, min = 2785, ratio = 2.785F }); //Int	下降口传感器上限		读/写	数值显示	DB8.DBW88	Downport_Highest_limit	mv	10000 	1000 
            plcVarThreadHoldMap.Add(".Downport_Lowest_limit", new ThresHold() { max = 25065, min = 0, ratio = 2.785F });  //Int	下降口传感器下限		读/写	数值显示	DB8.DBW90	Downport_Lowest_limit	mv	9000 	0 
            ...
            plcVarThreadHoldMap.Add(".Store_manual_speed", new ThresHold() { max = 9000, min = 100 }); //Store_manual_speed		9000 	100 	
        ...
        private void initVarDescription()
        {
            ...
            plcVarDescriptionMap.Add(".Elevater_FaultReset_Q", "存储器故障复位");
